    ...
    <DndContext sensors={sensors} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      <div className="flex flex-col min-h-screen bg-zinc-900 p-8">
        <div className="max-w-6xl mx-auto w-full">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Drag and Drop Demo</h1>
            <p className="text-zinc-400">
              Drag any magnet onto the canvas to place it
            </p>
          </div>
          ...
          <div className="flex gap-12 items-center justify-center">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              {lastDroppedName && (
                <p className="text-sm text-zinc-400">
                  Last dropped: <span className="text-white font-medium">{lastDroppedName}</span> | Magnets placed: {placedMagnets.length}
                </p>
              )}
            </div>
            ...
            <div className="w-96 h-[600px] overflow-y-auto bg-zinc-800 rounded-lg p-4">
              {magnets.length === 0 ? (
                <p className="text-zinc-400 text-sm">Loading magnets...</p>
              ) : (
                <div>
                  <p className="text-zinc-400 text-xs mb-3">{magnets.length} magnets available</p>
