    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute floating-action-button left-4 w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center shadow-lg z-10 hover:bg-blue-600 transition-colors"
        >
        ...
        <button
          ...
          className="absolute floating-action-button right-4 w-12 h-12 bg-green-500 rounded-full flex items-center justify-center shadow-lg z-10 hover:bg-green-600 transition-colors"
        >
          <CameraIcon className="w-6 h-6 text-white" />
        </button>

        {/* Bottom Drawer - 12vh on mobile, height-based rows on desktop */}
        <div className="absolute left-0 right-0 bottom-drawer bg-zinc-800 border-t border-zinc-700 overflow-x-auto overflow-y-hidden p-4 [&::-webkit-scrollbar]:h-0 [&::-webkit-scrollbar]:w-0">
          <div
